...
import { Box, Grid, Input, Button, Text, HStack } from "@chakra-ui/react";
  ...
  return (
    ...
    >
      ...
      <HStack spacing={4} mb={6}>
        <Button onClick={() => handleSort("name")} colorScheme="orange" variant={sortOption === "name" ? "solid" : "outline"}>
          Sort by Name
        </Button>
        <Button onClick={() => handleSort("username")} colorScheme="orange" variant={sortOption === "username" ? "solid" : "outline"}>
          Sort by Username
        </Button>
      </HStack>
      ...
      <Grid templateColumns={"repeat(auto-fit, minmax(250px, 1fr))"} gap={6} w="100%" maxW="1200px">
        {filteredUsers.map((user) => (
          <motion.div
            ...
            onMouseEnter={() => { setHoveredCard(user.id); playHoverSound(); }}
          ...
          >
            ...
            >
              ...
              <Text mt={2} color="#ff6e40" textShadow="0 0 10px #ff3f96">{user.username}</Text>
              <Button
                position="absolute"
                bottom={4}
                left="50%"
      ...
      {isModalOpen && selectedUser && (
        ...
        >
          ...
          >
            ...
            <Text mt={4} zIndex={2} position="relative">
